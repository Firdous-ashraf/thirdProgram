...
import os #Environment handling and unique filenames
import gradio as gr #Creates an interactive web interface
import whisper #Transcribes spoken audio to text
from gtts import gTTS #Converts text to speech (TTS)
from IPython.display import Audio
from groq import Groq #Interfaces with the Groq API to use LLaMA-3 models
import openai
import numpy as np
...
from typing import Tuple, Union ## For type annotations in function signatures
